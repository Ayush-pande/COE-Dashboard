...
public class AdminGetAllEmpGetDelegate implements IAdminGetAllEmpGetDelegate
{
	@Inject
	protected IMapEmployeeDTOToEmployee mapEmployeeDTOToEmployee;

	@Inject
	protected IAdminGetAllEmpGetApplicationService adminGetAllEmpGetApplicationService;

	@Override
	public ResponseEntity<List<Employee>> execute(AdminGetAllEmpGetParameters parameters)
	{
		...
		List<IEmployeeDTO> resultList = adminGetAllEmpGetApplicationService.adminGetAllEmpGet(authorization, filterConditions, paginationInfo, selectAttributes, sortFields);
