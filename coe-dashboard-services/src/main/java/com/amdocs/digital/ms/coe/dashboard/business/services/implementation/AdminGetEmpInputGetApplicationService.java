...
public class AdminGetEmpInputGetApplicationService implements IAdminGetEmpInputGetApplicationService
{
	@Override
	public List<IEmployeeDTO> adminGetEmpInputGet(String authorization, Filter filterConditions, String input, PaginationInfo paginationInfo, SelectedAttributes selectAttributes, SortFields sortFields)
	{
