...
public class LoginResponseLoginResponseDTOBidirectionalMapperTest extends TestSetUp
{
    @Inject
    protected IMapLoginResponseToLoginResponseDTO iMapLoginResponseToLoginResponseDTO;

    @Inject
    protected IMapLoginResponseDTOToLoginResponse iMapLoginResponseDTOToLoginResponse;

    @Test
    public void testLoginResponseLoginResponseDTOMapper()
    {
        LoginResponse loginResponse = createLoginResponse();
      
        ILoginResponseDTO loginResponseDTO = iMapLoginResponseToLoginResponseDTO.map(loginResponse);
        LoginResponse loginResponseMapped = iMapLoginResponseDTOToLoginResponse.map(loginResponseDTO);  
        assertEquals(loginResponse,loginResponseMapped);
    }
    ...
    private LoginResponse createLoginResponse(){
        ...
        loginResponse.setEmployee(createEmployee());
        loginResponse.setToken(getDefaultStringValue());
