...
public class EmployeeLoginPostDelegateTest extends TestSetUp
{
    @Inject
    protected IEmployeeLoginPostDelegate employeeLoginPostDelegate;

    @Test(expected = UnsupportedOperationException.class)
    public void testExecute()
    {
        EmployeeLoginPostParameters employeeLoginPostParameters = createEmployeeLoginPostParameters();

        //TODO implement test accordingly
        employeeLoginPostDelegate.execute(employeeLoginPostParameters);
    }
    ...
    private EmployeeLoginPostParameters createEmployeeLoginPostParameters(){
        EmployeeLoginPostParameters employeeLoginPostParameters = new EmployeeLoginPostParameters();
        employeeLoginPostParameters.setEmployee(createEmployee());
        return employeeLoginPostParameters;
    }
