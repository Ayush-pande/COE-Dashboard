...
public class EmployeeRegisterPostDelegateTest extends TestSetUp
{
    @Inject
    protected IEmployeeRegisterPostDelegate employeeRegisterPostDelegate;

    @Test(expected = UnsupportedOperationException.class)
    public void testExecute()
    {
        EmployeeRegisterPostParameters employeeRegisterPostParameters = createEmployeeRegisterPostParameters();

        //TODO implement test accordingly
        employeeRegisterPostDelegate.execute(employeeRegisterPostParameters);
    }
    ...
    private EmployeeRegisterPostParameters createEmployeeRegisterPostParameters(){
        EmployeeRegisterPostParameters employeeRegisterPostParameters = new EmployeeRegisterPostParameters();
        employeeRegisterPostParameters.setEmployee(createEmployee());
        return employeeRegisterPostParameters;
    }
