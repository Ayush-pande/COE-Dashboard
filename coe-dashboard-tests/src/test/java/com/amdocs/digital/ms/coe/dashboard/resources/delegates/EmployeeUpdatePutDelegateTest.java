...
public class EmployeeUpdatePutDelegateTest extends TestSetUp
{
    @Inject
    protected IEmployeeUpdatePutDelegate employeeUpdatePutDelegate;

    @Test(expected = UnsupportedOperationException.class)
    public void testExecute()
    {
        EmployeeUpdatePutParameters employeeUpdatePutParameters = createEmployeeUpdatePutParameters();

        //TODO implement test accordingly
        employeeUpdatePutDelegate.execute(employeeUpdatePutParameters);
    }
    ...
    private EmployeeUpdatePutParameters createEmployeeUpdatePutParameters(){
        EmployeeUpdatePutParameters employeeUpdatePutParameters = new EmployeeUpdatePutParameters();
        employeeUpdatePutParameters.setAuthorization(getDefaultStringValue());
        employeeUpdatePutParameters.setEmployee(createEmployee());
        return employeeUpdatePutParameters;
    }
