...
public class EmployeeForgotPasswordPostDelegateTest extends TestSetUp
{
    @Inject
    protected IEmployeeForgotPasswordPostDelegate employeeForgotPasswordPostDelegate;

    @Test(expected = UnsupportedOperationException.class)
    public void testExecute()
    {
        EmployeeForgotPasswordPostParameters employeeForgotPasswordPostParameters = createEmployeeForgotPasswordPostParameters();

        //TODO implement test accordingly
        employeeForgotPasswordPostDelegate.execute(employeeForgotPasswordPostParameters);
    }
    ...
    private EmployeeForgotPasswordPostParameters createEmployeeForgotPasswordPostParameters(){
        EmployeeForgotPasswordPostParameters employeeForgotPasswordPostParameters = new EmployeeForgotPasswordPostParameters();
        employeeForgotPasswordPostParameters.setEmployee(createEmployee());
        return employeeForgotPasswordPostParameters;
    }
