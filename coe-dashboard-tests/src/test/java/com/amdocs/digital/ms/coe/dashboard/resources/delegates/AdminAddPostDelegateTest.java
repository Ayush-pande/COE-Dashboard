...
public class AdminAddPostDelegateTest extends TestSetUp
{
    @Inject
    protected IAdminAddPostDelegate adminAddPostDelegate;

    @Test(expected = UnsupportedOperationException.class)
    public void testExecute()
    {
        AdminAddPostParameters adminAddPostParameters = createAdminAddPostParameters();

        //TODO implement test accordingly
        adminAddPostDelegate.execute(adminAddPostParameters);
    }
    ...
    private AdminAddPostParameters createAdminAddPostParameters(){
        AdminAddPostParameters adminAddPostParameters = new AdminAddPostParameters();
        adminAddPostParameters.setAuthorization(getDefaultStringValue());
        adminAddPostParameters.setEmployee(createEmployee());
        return adminAddPostParameters;
    }
