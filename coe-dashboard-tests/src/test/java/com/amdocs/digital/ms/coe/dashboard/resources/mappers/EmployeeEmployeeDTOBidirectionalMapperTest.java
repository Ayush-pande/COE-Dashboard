...
public class EmployeeEmployeeDTOBidirectionalMapperTest extends TestSetUp
{
    @Inject
    protected IMapEmployeeToEmployeeDTO iMapEmployeeToEmployeeDTO;

    @Inject
    protected IMapEmployeeDTOToEmployee iMapEmployeeDTOToEmployee;

    @Test
    public void testEmployeeEmployeeDTOMapper()
    {
        Employee employee = createEmployee();
      
        IEmployeeDTO employeeDTO = iMapEmployeeToEmployeeDTO.map(employee);
        Employee employeeMapped = iMapEmployeeDTOToEmployee.map(employeeDTO);  
        assertEquals(employee,employeeMapped);
    }
