...
public class AdminDeleteDeleteDelegateTest extends TestSetUp
{
    @Inject
    protected IAdminDeleteDeleteDelegate adminDeleteDeleteDelegate;

    @Test(expected = UnsupportedOperationException.class)
    public void testExecute()
    {
        AdminDeleteDeleteParameters adminDeleteDeleteParameters = createAdminDeleteDeleteParameters();

        //TODO implement test accordingly
        adminDeleteDeleteDelegate.execute(adminDeleteDeleteParameters);
    }
    ...
    private AdminDeleteDeleteParameters createAdminDeleteDeleteParameters(){
        AdminDeleteDeleteParameters adminDeleteDeleteParameters = new AdminDeleteDeleteParameters();
        adminDeleteDeleteParameters.setAuthorization(getDefaultStringValue());
        adminDeleteDeleteParameters.setEmployee(createEmployee());
        return adminDeleteDeleteParameters;
    }
