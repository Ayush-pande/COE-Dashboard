...
public class EmployeeResetPasswordPostDelegateTest extends TestSetUp
{
    @Inject
    protected IEmployeeResetPasswordPostDelegate employeeResetPasswordPostDelegate;

    @Test(expected = UnsupportedOperationException.class)
    public void testExecute()
    {
        EmployeeResetPasswordPostParameters employeeResetPasswordPostParameters = createEmployeeResetPasswordPostParameters();

        //TODO implement test accordingly
        employeeResetPasswordPostDelegate.execute(employeeResetPasswordPostParameters);
    }
    ...
    private EmployeeResetPasswordPostParameters createEmployeeResetPasswordPostParameters(){
        EmployeeResetPasswordPostParameters employeeResetPasswordPostParameters = new EmployeeResetPasswordPostParameters();
        employeeResetPasswordPostParameters.setAuthorization(getDefaultStringValue());
        employeeResetPasswordPostParameters.setEmployee(createEmployee());
        return employeeResetPasswordPostParameters;
    }
